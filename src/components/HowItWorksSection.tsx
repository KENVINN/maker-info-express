      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {steps.map((step, i) => (
            <div
              key={i}
              className="flex flex-col items-center text-center p-8 rounded-2xl bg-background neon-border-blue hover:neon-glow-blue transition-all duration-300 group"
            >
