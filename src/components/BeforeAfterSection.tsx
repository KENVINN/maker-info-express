      ...
      <div className="container px-4">
        ...
        <ScrollReveal delay={200}>
          ...
          >
            ...
            <span className="absolute top-4 left-4 bg-background/80 backdrop-blur px-3 py-1 rounded-md text-xs font-heading font-bold text-foreground z-20">ANTES</span>
            <span className="absolute top-4 right-4 bg-background/80 backdrop-blur px-3 py-1 rounded-md text-xs font-heading font-bold text-primary z-20">DEPOIS</span>
          </div>
        </ScrollReveal>
      </div>
    </section>
